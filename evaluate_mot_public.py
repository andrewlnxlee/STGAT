...
def run_eval():
    ...
    if len(test_set) == 0:
        print("❌ 数据集为空，请先运行 convert_mot_public.py")
        return
    ...
    print("正在评估 MOTChallenge (Public Detections)...")
    ...
    print("\n" + "="*80)
    print("MOTChallenge (MOT17 Public Detections) Evaluation")
    print("="*80)
